-- ===============================================
-- SISTEMA OBSIDIAN SIMPLIFICADO - SCRIPT COMPLETO
-- ===============================================
-- Este script elimina el sistema anterior y crea solo
-- el sistema de notas Obsidian con flashcards automáticas
-- VERSIÓN CORREGIDA - Incluye todas las correcciones
-- ===============================================

-- ========== LIMPIAR SISTEMA ANTERIOR ==========
-- Eliminar tablas del sistema original en orden correcto
drop table if exists public.note_deck_links cascade;
