...
export default function ExamStudyMode({ 
  ...
  // Todos los hooks deben ejecutarse ANTES de cualquier retorno condicional
  ...
  // useEffect debe ejecutarse antes de cualquier retorno condicional
  useEffect(() => {
    if (isOpen) {
      setCurrentIndex(0);
      setShowAnswer(false);
  ...
  // Validación de seguridad - DESPUÉS de todos los hooks
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {currentCard?.type === 'multiple_choice' ? (
          ...
          <div className="flex-1 flex flex-col justify-center items-center w-full" style={{ minHeight: 'calc(100vh - 80px)' }}>
            ...
            {/* Espacio fijo para botones - Solo correcto/incorrecto para modo examen */}
